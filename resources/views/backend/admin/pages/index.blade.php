              ...
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Appoint Doctor List</b> 
                    <a href="{{route('doctor.appoint.list')}}" class="float-right">
                    	@php
	                      $i = 0;
	                    @endphp
                ...
                <a href="{{route('admin.user.edit')}}" class="btn btn-primary btn-block"><b>Update Profile</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- Profile Image -->
