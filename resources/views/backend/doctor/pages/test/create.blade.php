          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text"></p>
                  <form action="{{route('test.store',$patient_ids)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label>Test</label>
                        <input type="text" name="Test_name" class="form-control" autocomplete="off">
                      </div>
                      
                    <div class="form-group">
                      <input type="submit" name="cratePrescriptiion" class="btn btn-primary btn-block form-control" value="Add Test">
                    </div>
                </form>
              </div>
            </div>
